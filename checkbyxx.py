...
class BookStorageViewer(QWidget):
    ...
    def setUpUI(self):
        ...
        searchCondision = ['按期刊名查询', '按期刊号查询', '按作者查询', '按分类查询', '按出版社查询','自定义']
        ...
        self.queryModel.setHeaderData(0, Qt.Horizontal, "期刊名")
        self.queryModel.setHeaderData(1, Qt.Horizontal, "期刊号")
